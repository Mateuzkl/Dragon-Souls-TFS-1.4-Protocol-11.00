...
function creatureSayCallback(cid, type, msg)
    ...
    if msgcontains(msg, 'yes') then
        player:teleportTo(Position(1110, 1760, 9))
        Position(1110, 1760, 9):sendMagicEffect(CONST_ME_TELEPORT)
...
keywordHandler:addKeyword({'destination'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Gostaria de ir para a Lost Island?'})
