...
if(NpcSystem == nil) then
	...
	dofile('lib/npcsystem/keywordhandler.lua')
	dofile('lib/npcsystem/queue.lua')
	dofile('lib/npcsystem/npchandler.lua')
	dofile('lib/npcsystem/modules.lua')
