...
combatDist:setParameter(COMBAT_PARAM_TYPE, COMBAT_DEATHDAMAGE)
combatDist:setParameter(COMBAT_PARAM_EFFECT, 131)
combatDist:setParameter(COMBAT_PARAM_DISTANCEEFFECT, CONST_ANI_SUDDENDEATH)
...
function onCastSpell(creature, variant)
    ...
    if target:isPlayer() then
        ...
        target:sendTextMessage(MESSAGE_EVENT_ADVANCE, 'Voc� est� amaldi�oado!')
    end
