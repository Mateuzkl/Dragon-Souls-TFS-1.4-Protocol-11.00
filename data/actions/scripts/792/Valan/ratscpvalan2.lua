...
piece11pos = {x=504, y=258, z=13, stackpos=2}
...
eng11 = {x=504, y=258, z=13, stackpos=2}
...
if item.uid == 6037 and item.itemid == 4333 and getpiece1.itemid == 2813 and getpiece2.itemid == 2813 and getpiece3.itemid == 2813 and getpiece4.itemid == 2813 and getpiece5.itemid == 2813 and getpiece6.itemid == 2813 and getpiece7.itemid == 2897 and getpiece.itemid == 2897 and getpiece.itemid == 2897 and geteng10.itemid == 2897 and getpiece11.itemid == 1355 then
...
doSendAnimatedText(getPlayerPosition(cid), "Schzzz", TEXTCOLOR_BLUE)
doSendMagicEffect(topos,10)
doSendMagicEffect(getPlayerPosition(cid),10)
doTransformItem(item.uid,item.itemid+1)
elseif item.uid == 6037 and item.itemid == 4334 then
 doTransformItem(item.uid,item.itemid-1)
else
doPlayerSendTextMessage(cid,22,"Sorry you need the sequence of mystic books.")
end
return 1
end