function onUse(player, item, fromPosition, target, toPosition, isHotkey)
    local piece1pos = Position(648, 639, 11)
    local rockpos = Position(648, 639, 11)
    local getpiece1 = Tile(piece1pos):getItemById(1354)

    if item:getActionId() == 109 and item:getId() == 1945 and getpiece1 then
        getpiece1:remove()
    ...
    elseif item:getActionId() == 109 and item:getId() == 1946 then
