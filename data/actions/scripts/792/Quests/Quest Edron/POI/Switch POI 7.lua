function onUse(player, item, fromPosition, target, toPosition, isHotkey)
    local piece1pos = Position(646, 639, 11)
    local rockpos = Position(646, 639, 11)
    local getpiece1 = Tile(piece1pos):getItemById(1354)

    if item:getActionId() == 111 and item:getId() == 1945 and getpiece1 then
        getpiece1:remove()
    ...
    elseif item:getActionId() == 111 and item:getId() == 1946 then
