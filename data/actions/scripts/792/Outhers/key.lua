function onUse(cid, item, frompos, item2, topos)
	if item.actionid == 10000 then
		...
		if item.actionid == item2.actionid then
			...
			or item2.itemid == 3544
			or item2.itemid == 4913
			or item2.itemid == 4916
			or item2.itemid == 5278 then
				doTransformItem(item2.uid, item2.itemid+2)
			elseif item2.itemid == 1210 
			or item2.itemid == 1213
			or item2.itemid == 1232
			...
			or item2.itemid == 3546
			or item2.itemid == 4915
			or item2.itemid == 4918
			or item2.itemid == 5280 then
				doTransformItem(item2.uid, item2.itemid-2)
			elseif item2.itemid == 5110 
			or item2.itemid == 5144
			or item2.itemid == 5123
			or item2.itemid == 1223
			or item2.itemid == 5128 
			or item2.itemid == 3547
			or item2.itemid == 5101
			or item2.itemid == 5736 then
				doTransformItem(item2.uid, item2.itemid+1)
			elseif item2.itemid == 5111 
			or item2.itemid == 5145
			or item2.itemid == 3548
			or item2.itemid == 5129
			or item2.itemid == 1224
			or item2.itemid == 5124
			or item2.itemid == 5102
			or item2.itemid == 5737 then
				doTransformItem(item2.uid, item2.itemid-1)
			end
		...
		elseif item2.itemid >= 1231 and item2.itemid <= 1236 then
			doPlayerSendCancel(cid, "The key does not match.")
		elseif item2.itemid >= 5143 and item2.itemid <= 1236 then
			doPlayerSendCancel(cid, "The key does not match.")
