...
--FURNITURE 
 ...
 { 
   ...
   offers = { 
			...
			{name = "Gilded Imbuing Shrine", itemtype = 27760, price = 200, count = 1, type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, icons = { "" },
                description = "Buy an incredible Gilded Imbuing Shrine to decorate your home.",
				},  
			{name = "Imbuing Shrine", itemtype = 27759, price = 150, count = 1, type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, icons = { "" },
