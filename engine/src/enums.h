...
enum itemAttrTypes : uint64_t {
	...
	ITEM_ATTRIBUTE_PRESSLOSS = 1ULL << 46
};
...
enum ConditionParam_t {
	...
	CONDITION_PARAM_STAT_ABSORBPERCENTALL = 56,
	CONDITION_PARAM_LUCK = 57,
...
enum ConditionType_t : uint64_t {
	...
	CONDITION_EXHAUST = 1ULL << 12, // unused
	...
	CONDITION_SPELLCOOLDOWN = 1ULL << 26,
	CONDITION_SPELLGROUPCOOLDOWN = 1ULL << 27,
	CONDITION_STUN = 1ULL << 28,
	CONDITION_STAMINAREGEN = 1ULL << 29,
	CONDITION_SOULBONUS = 1ULL << 30,
	CONDITION_SILENCE = 1ULL << 31,
	CONDITION_HASTEGA = 1ULL << 32,
	CONDITION_EXHAUSTED = 1ULL << 33,
	CONDITION_REVIVE = 1ULL << 34,
	CONDITION_DOUBLE_XP = 1ULL << 35,
	CONDITION_ROOTED = 1ULL << 36
};
...
enum ReturnValue {
	...
	RETURNVALUE_NONVALAN_CANNOTATTACKPLAYER,
	RETURNVALUE_SAMEIP_CANNOTATTACKPLAYER,
    ...
    RETURNVALUE_YOUARESILENCED,
    RETURNVALUE_YOURMSGCOOLDWN,
};
