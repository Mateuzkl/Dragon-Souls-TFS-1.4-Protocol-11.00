...
class ConfigManager
{
	public:
		...
		enum boolean_config_t {
			...
			PUSH_WHEN_ATTACKING,
			POTION_CAN_EXHAUST_USEITEM,
			RUNE_CAN_EXHAUST_USEITEM,
			BLOCK_SAME_IP_PVP,
			ENABLE_WINGS,
			ENABLE_AURAS,
			ENABLE_SHADERS,
		...
		enum string_config_t {
			...
			RESET_NEW_LEVEL,
			RESET_STAT_BONUS,	
			RESET_SORCERER_MAGLEVEL,
			RESET_DRUID_MAGLEVEL,
			RESET_PALADIN_DISTANCE,
			RESET_PALADIN_MAGLEVEL,
			RESET_KNIGHT_SWORD,
			RESET_KNIGHT_AXE,
			RESET_KNIGHT_CLUB,
			RESET_KNIGHT_FIST,
			RESET_KNIGHT_MAGLEVEL,
			RESET_KNIGHT_SHIELD,
			RESET_PALADIN_SHIELD,
			...
			EXHAUST_RUNE_INTERVAL,
			EXHAUST_USEITEM_INTERVAL,
			EXHAUST_MACHETE_INTERVAL,
			EXHAUST_PUSH_INTERVAL,
		...
		enum floating_config_t {
			...
			RATE_ATTACK_SPEED,
			CRITICAL_HEAL_PERCENT_KNIGHT,
			CRITICAL_HEAL_PERCENT_PALADIN,
			CRITICAL_HEAL_PERCENT_MAGE,
			CRITICAL_HEAL_PERCENT_DRUID,
			CRITICAL_HEAL_PERCENT_GOD,
			CRITICAL_MULTIPLIER_KNIGHT,
			CRITICAL_MULTIPLIER_PALADIN,
			CRITICAL_MULTIPLIER_MAGE,
			CRITICAL_MULTIPLIER_DRUID,
