...
public:
  ...
  int32_t getDuration() const { return getIntAttr(ITEM_ATTRIBUTE_DURATION); }
...
protected:
  ...
  const static uint64_t intAttributeTypes =
      ...
      ITEM_ATTRIBUTE_DOORID | ITEM_ATTRIBUTE_DURATION_TIMESTAMP |
      ITEM_ATTRIBUTE_IMBUINGSLOTS | ITEM_ATTRIBUTE_OPENED |
      ITEM_ATTRIBUTE_QUICKLOOTCONTAINER | ITEM_ATTRIBUTE_IMBUED |
      ITEM_ATTRIBUTE_WRAPID | ITEM_ATTRIBUTE_CLASSIFICATION |
      ITEM_ATTRIBUTE_TIER | ITEM_ATTRIBUTE_ELEMENTICE |
      ITEM_ATTRIBUTE_ELEMENTEARTH | ITEM_ATTRIBUTE_ELEMENTFIRE |
      ITEM_ATTRIBUTE_ELEMENTENERGY | ITEM_ATTRIBUTE_ELEMENTDEATH |
      ITEM_ATTRIBUTE_ELEMENTHOLY | ITEM_ATTRIBUTE_ABSORBICE |
      ITEM_ATTRIBUTE_ABSORBEARTH | ITEM_ATTRIBUTE_ABSORBFIRE |
      ITEM_ATTRIBUTE_ABSORBENERGY | ITEM_ATTRIBUTE_ABSORBDEATH |
      ITEM_ATTRIBUTE_ABSORBHOLY | ITEM_ATTRIBUTE_ABSORB_PHYSICAL;
  const static uint64_t stringAttributeTypes =
...
public:
  ...
  int32_t getDuration() const {
    ...
    // Always return the original duration from items.xml, never the remaining
    // time
    return getIntAttr(ITEM_ATTRIBUTE_DURATION);
  }
  ...
  uint32_t getQuicklootAttr() const {
    if (hasAttribute(ITEM_ATTRIBUTE_QUICKLOOTCONTAINER)) {
      return static_cast<uint32_t>(
          getIntAttr(ITEM_ATTRIBUTE_QUICKLOOTCONTAINER));
    }
    return 0;
  }
  ...
  int32_t getImbuingSlots() const { return items[id].imbuingSlots; }
  ...
  uint16_t getItemMaxCount() const { return items[id].getItemMaxCount(); }
  ...
  // Dynamic absorb percent functions (following same pattern as
  // getElementDamage)
  uint16_t getAbsorbPercent(CombatType_t combatType) const {
    ...
    case COMBAT_ICEDAMAGE:
      if (hasAttribute(ITEM_ATTRIBUTE_ABSORBICE)) {
        totalAbsorb +=
            static_cast<uint16_t>(getIntAttr(ITEM_ATTRIBUTE_ABSORBICE));
      }
      break;
    case COMBAT_EARTHDAMAGE:
      if (hasAttribute(ITEM_ATTRIBUTE_ABSORBEARTH)) {
        totalAbsorb +=
            static_cast<uint16_t>(getIntAttr(ITEM_ATTRIBUTE_ABSORBEARTH));
      }
      break;
    case COMBAT_FIREDAMAGE:
      if (hasAttribute(ITEM_ATTRIBUTE_ABSORBFIRE)) {
        totalAbsorb +=
            static_cast<uint16_t>(getIntAttr(ITEM_ATTRIBUTE_ABSORBFIRE));
      }
      break;
    case COMBAT_ENERGYDAMAGE:
      if (hasAttribute(ITEM_ATTRIBUTE_ABSORBENERGY)) {
        totalAbsorb +=
            static_cast<uint16_t>(getIntAttr(ITEM_ATTRIBUTE_ABSORBENERGY));
      }
      break;
    case COMBAT_DEATHDAMAGE:
      if (hasAttribute(ITEM_ATTRIBUTE_ABSORBDEATH)) {
        totalAbsorb +=
            static_cast<uint16_t>(getIntAttr(ITEM_ATTRIBUTE_ABSORBDEATH));
      }
      break;
    case COMBAT_HOLYDAMAGE:
      if (hasAttribute(ITEM_ATTRIBUTE_ABSORBHOLY)) {
        totalAbsorb +=
            static_cast<uint16_t>(getIntAttr(ITEM_ATTRIBUTE_ABSORBHOLY));
      }
      break;
    case COMBAT_PHYSICALDAMAGE:
      if (hasAttribute(ITEM_ATTRIBUTE_ABSORB_PHYSICAL)) {
        totalAbsorb +=
            static_cast<uint16_t>(getIntAttr(ITEM_ATTRIBUTE_ABSORB_PHYSICAL));
      }
      break;
    default:
      break;
  ...
  void setDodge(uint16_t value) { getAttributes()->dodge = value; }
