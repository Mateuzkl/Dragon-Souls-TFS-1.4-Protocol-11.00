...
enum ShootType_t : uint16_t {
	...
	CONST_ANI_ELEMENTALBOLT = 28,
	CONST_ANI_ETHEREALSPEAR = 29,
	CONST_ANI_ICE = 30,
	CONST_ANI_EARTH = 31,
	CONST_ANI_HOLY = 32,
	CONST_ANI_SUDDENDEATH = 33,
	CONST_ANI_FLASHARROW = 35,
	CONST_ANI_FLAMMINGARROW = 36,
	CONST_ANI_SHIVERARROW = 37,
	CONST_ANI_ENERGYBALL = 38,
	CONST_ANI_SMALLICE = 39,
	CONST_ANI_SMALLHOLY = 40,
	CONST_ANI_SMALLEARTH = 41,
	CONST_ANI_EARTHARROW = 42,
	CONST_ANI_EXPLOSION = 43,
	CONST_ANI_CAKE = 44,

	CONST_ANI_TARSALARROW = 45,
	CONST_ANI_VORTEXBOLT = 46,

	CONST_ANI_PRISMATICBOLT = 50,
	CONST_ANI_CRYSTALLINEARROW = 51,
	CONST_ANI_DRILLBOLT = 52,
	CONST_ANI_ENVENOMEDARROW = 53,

	CONST_ANI_GLOOTHSPEAR = 55,
	CONST_ANI_SIMPLEARROW = 56,

	CONST_ANI_LEAFSTAR = 58,
	CONST_ANI_DIAMONDARROW = 59,
	CONST_ANI_SPECTRALBOLT = 60,
...
enum TextColor_t : uint8_t {
	...
	// Extended palette (do not modify existing values above)
	TEXTCOLOR_BLACK = 0,
	TEXTCOLOR_BROWN = 120,
	TEXTCOLOR_CADETBLUE = 100,
	TEXTCOLOR_CORAL = 200,
	TEXTCOLOR_CRIMSON = 188,
	TEXTCOLOR_CYAN = TEXTCOLOR_LIGHTBLUE, // 35
	TEXTCOLOR_DARKBLUE = 3,
	TEXTCOLOR_DARKBROWN = 78,
	TEXTCOLOR_DARKCYAN = 21,
	TEXTCOLOR_DARKGOLD = 163,
	// TEXTCOLOR_DARKGREEN already defined as 18
	TEXTCOLOR_DARKKHAKI = 171,
	TEXTCOLOR_DARKMAGENTA = 75,
	TEXTCOLOR_DARKOLIVEGREEN = 91,
	TEXTCOLOR_DARKORANGE = 156,
	TEXTCOLOR_DARKORCHID = 118,
	TEXTCOLOR_DARKPINK = 152,
	TEXTCOLOR_DARKPURPLE = 112,
	// TEXTCOLOR_DARKRED already defined as 108
	TEXTCOLOR_DARKSEAGREEN = 135,
	TEXTCOLOR_DARKSLATEBLUE = 87,
	TEXTCOLOR_DARKSLATEGREY = 50,
	TEXTCOLOR_DARKVIOLET = 113,
	TEXTCOLOR_DEEPPINK = 189,
	TEXTCOLOR_DEEPSKYBLUE = 29,
	TEXTCOLOR_DODGERBLUE = 59,
	TEXTCOLOR_FIREBRICK = 151,
	TEXTCOLOR_FORESTGREEN = 55,
	TEXTCOLOR_FUCHSIA = 185,
	TEXTCOLOR_GOLD = 205,
	TEXTCOLOR_GREY = TEXTCOLOR_LIGHTGREY, // 129
	TEXTCOLOR_GREEN = 18, // alias to dark green code
	TEXTCOLOR_HOTPINK = 202,
	TEXTCOLOR_KHAKI = 213,
	TEXTCOLOR_LAWNGREEN = 138,
	TEXTCOLOR_LIGHTAQUA = 64,
	// TEXTCOLOR_LIGHTBLUE already defined as 35
	// TEXTCOLOR_LIGHTGREEN already defined as 30
	TEXTCOLOR_LIGHTORANGE = 204,
	TEXTCOLOR_LIGHTSLATEGREY = TEXTCOLOR_LIGHTGREY, // 129
	TEXTCOLOR_LIGHTSTEELBLUE = 173,
	TEXTCOLOR_LIME = TEXTCOLOR_LIGHTGREEN, // 30
	TEXTCOLOR_LIMEGREEN = 67,
	TEXTCOLOR_MEDIUMAQUAMARINE = 106,
	TEXTCOLOR_MEDIUMORCHID = 161,
	TEXTCOLOR_MEDIUMSEAGREEN = 99,
	TEXTCOLOR_MEDIUMSLATEBLUE = 131,
	TEXTCOLOR_MEDIUMSPRINGGREEN = 34,
	TEXTCOLOR_MEDIUMVIOLET = 153,
	TEXTCOLOR_MIDNIGHTBLUE = 45,
	TEXTCOLOR_OLIVE = 126,
	// TEXTCOLOR_ORANGE already defined as 198
	TEXTCOLOR_ORANGERED = 192,
	TEXTCOLOR_ORCHID = 203,
	TEXTCOLOR_PALEGREEN = 141,
	TEXTCOLOR_PALEPINK = 208,
	TEXTCOLOR_PINK = 190,
	// TEXTCOLOR_PURPLE already defined as 155
	// TEXTCOLOR_RED already defined as 180
	TEXTCOLOR_ROSYBROWN = 165,
	TEXTCOLOR_ROYALBLUE = TEXTCOLOR_MAYABLUE, // 95
	TEXTCOLOR_SADDLEBROWN = 121,
	TEXTCOLOR_SALMON = 201,
	TEXTCOLOR_SANDYBROWN = 206,
	TEXTCOLOR_SEAGREEN = 56,
	TEXTCOLOR_SIENNA = 157,
	TEXTCOLOR_SILVER = 172,
	// TEXTCOLOR_SKYBLUE already defined as 143 (client uses 21 differently)
	TEXTCOLOR_SLATEBLUE = 125,
	TEXTCOLOR_SLATEGREY = TEXTCOLOR_LIGHTGREY, // 129
	TEXTCOLOR_SPRINGGREEN = 33,
	TEXTCOLOR_STEELBLUE = 94,
	TEXTCOLOR_TAN = 207,
	// TEXTCOLOR_TEAL already defined (alias of LIGHTBLUE/35)
	TEXTCOLOR_THISTLE = 209,
	TEXTCOLOR_TOMATO = TEXTCOLOR_MAYARED, // 194
	TEXTCOLOR_TURQUOISE = 107,
	TEXTCOLOR_VIOLET = 119,
	TEXTCOLOR_WHITE = TEXTCOLOR_WHITE_EXP, // 215
	// TEXTCOLOR_YELLOW already defined as 210
	TEXTCOLOR_YELLOWGREEN = 175,
	TEXTCOLOR_NONE = 255,
};
